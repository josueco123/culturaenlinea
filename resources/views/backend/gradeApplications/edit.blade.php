      ...
      <div class="row">
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <br>
              <div class="row">
                <div class="col">
                 <form id="filters" action="{{ route('backend.gradeApplications.update', ['id' => $application->id]) }}" method="post">
         			        @csrf
                        ...
                        <table id="datatable" class="table table-bordered">
                          ...
                          <tbody>
                            @foreach ($application->incentive->criteria as $criteria)
                                <tr>
                                  <td >
                                    <input type="hidden" name="idcriteria-{{$criteria->id}}" value="{{ $criteria->id }}">
                                    {{ $criteria->name }}
                                  </td>
                                ...
                                @endphp
                                  ...
                                  <td class="text-center" style="width:250px">
                                      <textarea class="form-control" rows="2" name="comment-{{$criteria->id}}" minlength="200" maxlength="1000">{{$comment}}</textarea>
                                  </td>
                                </tr>
                            @endforeach
                          </tbody>
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="form-group">
                            ...
                            <textarea {{-- id="summernote1" --}} minlength="200" maxlength="1000" class="form-control" name="information" rows="3" >{!! $grade_application[0]->comment !!}</textarea>
                          ...
                          <div class="form-group m-0">
                              ...
                              @if ($grade_application[0]->recommend == 0)
                                <div class="custom-control custom-radio custom-control-inline ml-3 mr-3">
                                  <input type="radio" id="recommend1" class="custom-control-input" name="recommend" value="0" checked/>
                              ...
                              @elseif($grade_application[0]->recommend == 1)
                                <div class="custom-control custom-radio custom-control-inline ml-3 mr-3">
                                  <input type="radio" id="recommend1" class="custom-control-input" name="recommend" value="0" />
                                  <label class="custom-control-label" for="recommend1">No la recomiendo</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline ml-3 mr-3">
                                  <input type="radio" id="recommend2" class="custom-control-input" name="recommend" value="1" checked/>
                                  <label class="custom-control-label" for="recommend2">Sí la recomiendo</label>
                                </div>
                              @else
                                <div class="custom-control custom-radio custom-control-inline ml-3 mr-3">
                      ...
                      <br><center><input type="submit" class="btn btn-primary" value="Actualizar Calificación"></center>
