    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12 text-center text-md-left">
          <h1 class="text-white">Crear rol</h1>
          <p class="lead text-light mb-0">Crea un rol con la información básica</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <form action="{{ route('backend.roles.storage') }}" method="post">

            @csrf

            <h4 class="text-center text-md-left mb-4">Formulario para la creación del rol</h4>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="name" class="form-control @error('name') is-invalid @enderror @error('slug') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Nombre del rol *" required>
                  @error('name')
