    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12 text-center text-md-left">
          <h1 class="text-white">Detalles de la notificación</h1>
          <p class="lead text-light mb-0">Detalles de las aplicaciones registradas en nuestro portal</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <h4 class="text-center text-md-left mb-4">{{ $notification->title }}</h4>
