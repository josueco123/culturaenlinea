    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12 text-center text-md-left">
          ...
          <p class="lead text-light mb-0">Crea un usuario con la información básica</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <form action="{{ route('backend.users.storage') }}" method="post">

            @csrf

            <h4 class="text-center text-md-left mb-4">Formulario para la creación del usuario</h4>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="email" id="email" class="form-control @error('email') is-invalid @enderror " name="email" value="{{ old('email') }}" placeholder="Correo electrónico *" required>
                  @error('email')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-6 col-xl-3">
                      <div class="form-group">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" id="role_{{ $role->id }}" class="custom-control-input @error('roles') is-invalid @enderror" name="roles[]" value="{{ $role->id }}" {{ old('roles') && in_array($role->id, old('roles')) ? 'checked' : '' }}>
              ...
              <div class="col-12">
                <span class="small">Debe seleccionar al menos un rol *</span>
              </div>
            </div>
            ...
            <div class="row">
              ...
              @foreach ($permissions as $permission)
                <div class="col-md-6 col-xl-3">
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" id="permission_{{ $permission->id }}" class="custom-control-input @error('permissions') is-invalid @enderror" name="permissions[]" value="{{ $permission->id }}" {{ old('permissions') && in_array($permission->id, old('permissions')) ? 'checked' : '' }}>
