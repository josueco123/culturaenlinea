    ...
    <div class="row mt-1">
        <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            @foreach ($form->fields as $field)
                                ...
                                @php
                                    ...
                                    // if (!empty($registers)){
                                      ...
                                      /*if ( ($application->status->id == 3) && ($registers->toArray()[$pos]['state'] == 1)){
                                          $skip_field = true;
                                      }*/
                          ...
                          @if (!empty($registers))
                            @foreach ($registers as $element)
                              @if ($application->status->id == 3 && $element->state == 2 && $field->id == $element->field_id && $form->id == $element->form_id)
                                ...
                                @break
                              @elseif($application->status->id == 1)
                                <div class=" col-sm-12 offset-sm-0 col-md-10 offset-md-1 form-field">
                                    <div class="form-group m-0">
            ...
            <div id="step-content-{{$form_number}}" class="step-content lighten-3 @if ($step != $form_number)d-none @endif">
              @if (count($modulo_estimulos) > 0)
                <br>
                  <div class="card  mb-5">
                    <div class="card-body">
                      <h5 class="mt-0 mb-1">Documentacion para el Jurado</h5>
                      <hr class="ml-0 w-15">
                    ...
                    <div class="card-footer">
                        <div class="form-group ">
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">
                            Diligenciar Documentación para los Jurados (OBLIGATORIO NO SUBSANABLE)
                          </button>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Documentos para el jurado</h5>
                              ...
                              @if (!empty($registers) && $application->status->id == 3)
                                  @foreach ($modulo_estimulos as $mestimulos)
                                    @foreach ($modulo_estimulos_field as $field)
                                        @foreach ($registers as $element)
                                          @if ($application->status->id == 3 && $element->state == 2 && $field->id == $element->field_id )
                              ...
                              @else
                                  @foreach ($modulo_estimulos as $mestimulos)
                                    @foreach ($modulo_estimulos_field as $field)
                                      @if ( $field->form_id == $mestimulos->form_id)
                ...
                <div class="card  mb-5">
                    <div class="card-body">
                      ...
                      <hr class="ml-0 w-15">
                        ...
                        @if (count($modulo_estimulos) > 0)
                        <hr>
                          <b style="color:#E00202">Importante:</b><br>Por favor diligenciar los Documentos requeridos por el Jurado y dar click en finalizar proceso
                        @endif  
                    </div>
