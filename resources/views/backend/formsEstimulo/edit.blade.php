    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <form action="{{ route('estimulos.forms.update', ['id' => $form->form_id]) }}" method="post">

            @csrf
            <input type="hidden" name="_method" value="put">
            {{-- <input type="text" name="" value="{{ $form->form_id }}"> --}}
            ...
            <div class="row" style="display: none;">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input type="number" id="order" class="form-control" name="order" value="{{ old('name') ? old('name') : $form->order }}" placeholder="Posición del formulario" required readonly>
                </div>
              </div>
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" id="user_type_{{ $user_type->id }}" class="custom-control-input @error('user_types') is-invalid @enderror" name="user_types[]" value="{{ $user_type->id }}"  
                        ...
                        {{ old('user_types') && in_array($user_type->id, old('user_types')) ? 'checked' : '' }} checked="true">
