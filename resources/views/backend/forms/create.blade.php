    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12 text-center text-md-left">
          <h1 class="text-white">Crear formulario</h1>
          <p class="lead text-light mb-0">Crear formularios para un tipo de usuario</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <form action="{{ route('backend.forms.storage') }}" method="post">

            @csrf

            <h4 class="text-center text-md-left mb-4">Formulario para la creación del formulario</h4>
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input type="text" id="name" class="form-control" name="name" value="{{ old('name') }}" placeholder="Nombre del formulario" required>
                </div>
              </div>
