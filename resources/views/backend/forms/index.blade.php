    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12 text-center text-md-left">
          <h1 class="text-white">Formularios</h1>
        ...
        <div class="col-md-8 col-lg-9">
          ...
          <div class="row">
            ...
            <div class="col-12 text-center text-md-left mb-5">
              <form id="filters" action="{{ route('backend.forms.index') }}" action="GET">
                @csrf
                <div class="form-row">
            ...
            <div class="col-12 col-sm-auto mb-4 text-center text-sm-left">
              @if (request('call'))
                  @permission('crear-formularios')
                    <a href="{{ route('backend.forms.create', [ 'call' => request('call')]) }}" class="btn btn-success"><i class="fas fa-plus fa-fw"></i> Crear formulario</a>
                  @else
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          ...
                          @permission('actualizar-formularios')
                            <a href="{{ route('backend.forms.edit', ['id' => $form->form_id, 'call' => $form->call_id]) }}" class="btn btn-warning btn-sm mb-1 mb-lg-0"><i class="fas fa-pencil-alt"></i></a>
                          @endpermission
                          @permission('leer-campos')
                            <a href="{{ route('backend.fields.index', ['id' => $form->form_id, 'call' => $form->call_id,'idusertypes' => $form->idusertypes]) }}" class="btn btn-success btn-sm mb-1 mb-lg-0"><i class="fas fa-list-alt"></i>
                            </a>
                          @endpermission
                          @permission('borrar-formularios')
                            <a href="#" class="btn btn-danger btn-sm mb-1 mb-lg-0 deleteUserType" data-toggle="modal" data-target="#modalUserTypeDelete" data-url="{{ route('backend.forms.destroy', ['id' => $form->form_id, 'call' => $form->call_id]) }}"><i class="fas fa-trash-alt"></i></a>
                          @endpermission
                        </td>
                      </tr>
                    @endforeach
